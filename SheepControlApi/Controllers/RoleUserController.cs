...
namespace SheepControlApi.Controllers
{
    ...
    public class RoleUserController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Post(RoleUserRequestCreateRequest permissionRequest)
        {
            var identity = HttpContext.User.Identity as ClaimsIdentity;
        ...
        public IActionResult ToggleActive(int id)
        {
            ...
            var response1 = _AuthenticationBusiness.CheckPermissionControllerActionForUser(identity, Constants.CONTROLLER_ROLEUSER, Constants.ACTION_TOGGLEACTIVE);
